...
/**
 * RegisterPage
 * A production-style sign-up screen: social providers, email/password with
 * show-hide toggles, a live password-strength meter, terms acceptance, and
            ...
            <div className="relative z-10 w-full max-w-md rounded-xl bg-white p-8 shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                    ...
                    <div>
                        ...
                        {/* Strength meter (only once typing begins) */}
                        {password && (
                            <div className="mt-2">
